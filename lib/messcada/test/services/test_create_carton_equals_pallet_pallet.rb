...
module MesscadaApp
  class TestCreateCartonEqualsPalletPallet < MiniTestWithHooks
    ...
    def test_create_pallet
      ...
      params = { carton_id: carton_id, carton_quantity: 1, carton_equals_pallet: true }
    ...
    def test_create_pallet_fail
      ...
      params = { carton_id: carton_id, carton_quantity: 1, carton_equals_pallet: false }
      res = MesscadaApp::CreateCartonEqualsPalletPallet.call(current_user, params)
      refute res.success, 'Should not be able to create Pallet'
    end
  end
end
